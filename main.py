...
def format (valor):
    # Configurando a localidade para o formato brasileiro
    locale.setlocale(locale.LC_MONETARY, 'pt_BR.UTF-8')
    # Número a ser formatado
    numero = valor
    # Convertendo o número para uma string formatada
    numero_formatado = locale.currency(numero, grouping=True)
...
def format_num(valor):
    ...
    # Convertendo o número para uma string formatada
    numero_formatado = locale.format_string('%.2f', valor, grouping=True)
    return numero_formatado
